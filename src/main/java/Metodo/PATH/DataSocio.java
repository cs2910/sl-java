...
public class DataSocio {
    public static void main(String[] args) throws SQLException {
        ...
        ResultSet divida = con.createStatement().executeQuery("select * from pessoasJuridicasSocios where protocolo is null");
        while (divida.next()){
            String idcloud = divida.getString("idcloud");
            String dtSocio = divida.getString("dtsocio");
            String itemValor = null;
            System.out.println(idcloud);
            String urlPost = "https://tributos.betha.cloud/service-layer-tributos/api/pessoasJuridicasSocios/";
            ...
            con.createStatement().executeUpdate("update pessoasJuridicasSocios set protocolo = '"+itemValor+"' where idcloud = "+idcloud);
        }
    }
}
