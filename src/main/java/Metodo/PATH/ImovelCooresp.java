...
public class ImovelCooresp {
    public static void main(String[] args) throws SQLException {
        Connection con = new Conexao().conexaoBanco();
        ResultSet divida = con.createStatement().executeQuery("select idcloud,'{\"idIntegracao\": \"INTEGRACAO1\",\"imoveis\":{\"idGerado\": {\"id\":'||idcloud||'},\"idCorresponsavel\":'||idcnt ||'}}'\n" +
                "as nome from imoveiscoresponsavel  where protocolo is null ");
        while (divida.next()){
            String itemValor = null;
            String jsonBody = divida.getString("nome");
            String div = divida.getString("idcloud");
            String urlPost = "https://tributos.betha.cloud/service-layer-tributos/api/imoveis/";
            ...
            con.createStatement().executeUpdate("update imoveiscoresponsavel set protocolo = '"+itemValor+"' where idCloud = "+div);
        }
    }
}
